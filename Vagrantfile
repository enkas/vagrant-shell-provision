Vagrant.configure("2") do |config|
  ...
  # For Magento-EE
  # config.vm.hostname = "magento-demo-ee.dev"
  ...
  config.vm.synced_folder "./var/", "/var/www/html/var/", :mount_options => ["uid=500","gid=48","dmode=0777","fmode=0777"]
  config.vm.synced_folder "./media/", "/var/www/html/media/", :mount_options => ["uid=500","gid=48","dmode=0777","fmode=0777"]
